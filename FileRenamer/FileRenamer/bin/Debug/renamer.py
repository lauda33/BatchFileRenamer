...
class Renamer():
    ...
    def load_options(self,json_path):
        ...
        with open(json_path,encoding="UTF-8") as opt:
    ...
    def rename_the_path(self,path):
        ...
        if self.options != {}:
            ...
            for  file_name,file_ext,seed in zip(file_name_without_extensions,file_extensions,range(SEED,PATH_LEN+SEED)):
...
renamer.load_options(json_path="options.json")


renamer.rename_the_path(renamer.path)
